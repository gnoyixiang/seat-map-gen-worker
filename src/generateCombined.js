export default function test(
  ...
  function drawScreen(
    ...
    return [
      ...
      `x="${boundaryArea.left}"`,
      `y="${
        reverse ? boundaryArea.top + screenDistance : boundaryArea.bottom
      }"`,
      `height="${screenHeight}"`,
  ...
  function getSeatTemplatePrefixedId(prefix = "", templateId) {
    return `${prefix || ""}${templateId}`;
  }

  function getSingleSeat({ prefix } = {}) {
    return `
  ...
  function getSingleSeatSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getWheelchairSeat({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
        WHEELCHAIR_SEAT
  ...
  function getWheelchairCompanionSeat({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getSofaLeftSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getSofaCenterSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getSofaRightSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getBedSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
        BED_SEAT__SELECTED
  ...
  function getRestrictedViewSeat({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
  ...
  function getHoldSeatSelected({ prefix } = {}) {
    return `
      <symbol id="${getSeatTemplatePrefixedId(
        prefix,
        HOLD_SEAT__SELECTED
  ...
  function getAllSeatTemplates(props) {
  ...
  function mapSeatsByAreaRowCol(seats) {
    return (
      seats &&
  ...
  function getViewBox(
    ...
    const viewBox = mappedAreas.reduce(
      function (vb, area) {
        ...
        return {
          ...
          right:
            areaLeft + areaWidth > vb.right ? areaLeft + areaWidth : vb.right
        };
      },
    ...
    return {
      y:
        viewBox.top -
        ((viewBox.bottom - viewBox.top) * (vbScaleFactor - 1)) / 2,
      x:
        viewBox.left -
        ((viewBox.right - viewBox.left) * (vbScaleFactor - 1)) / 2,
